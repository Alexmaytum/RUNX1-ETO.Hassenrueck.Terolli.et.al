...
markers<- FindMarkers(object = cells, ident.1 = 6, ident.2 = 1, min.pct = 0.1)
...
# Write all genes
write.table(markers.out, file = 'binding_analysis/Dox5_all_DE_genes.tsv', sep = '\t', row.names = FALSE, quote = FALSE)

# Write only DE genes
markers.out.de<- markers.out %>% filter(abs(avg_log2FC) > 1 & p_val_adj < 0.01)
write.table(markers.out.de, file = 'binding_analysis/Dox5_DE_genes.tsv', sep = '\t', quote = FALSE, row.names = FALSE)
...
g<- DimPlot(cells, group.by = 'seurat_clusters') +
  ...
  scale_colour_manual(values = c('grey70', '#0000DD', 'grey70', 'grey70', 'grey70', 'grey70', '#DD0000', 'grey70', 'grey70')) +
  scale_x_continuous(limits = c(-10.5,10.5), breaks = seq(-10,10,5)) +
  scale_y_continuous(limits = c(-10.5,10.5), breaks = seq(-10,10,5))

ggsave(g, file = 'binding_analysis/Dox5_UMAP_highlighted.png', bg = 'white', height = 8, width = 8.5, units = 'in', dpi = 800)
ggsave(g, file = 'binding_analysis/Dox5_UMAP_highlighted.pdf', bg = 'white', height = 8, width = 8.5, units = 'in', dpi = 800)
...
g<- ggplot(markers, aes(x = avg_log2FC, y = -log10(p_val_adj), color = DE)) + geom_point() + theme_classic() +
  ...
  scale_x_continuous(breaks = seq(-12,12,3), limits = c(-12,13)) + 
...
ggsave(g, file = 'binding_analysis/Dox5_VolcanoPlot.png', bg = 'white', height = 8, width = 9, units = 'in', dpi = 800)
ggsave(g, file = 'binding_analysis/Dox5_VolcanoPlot.pdf', bg = 'white', height = 8, width = 9, units = 'in', dpi = 800)
...
ggsave(g, file = 'binding_analysis/Dox5_Fisher_test_results.png', bg = 'white', width = 8, height = 5, units = 'in', dpi = 800)  
ggsave(g, file = 'binding_analysis/Dox5_Fisher_test_results.pdf', bg = 'white', width = 8, height = 5, units = 'in', dpi = 800)
...
write.table(results.up, file = 'binding_analysis/Dox5_UpRegulated_Fisher_test_results.tsv', sep = '\t', quote = FALSE, row.names = FALSE)
write.table(results.down, file = 'binding_analysis/Dox5_DownRegulated_Fisher_test_results.tsv', sep = '\t', quote = FALSE, row.names = FALSE)

write.table(runx1_lost.downReg.KEGG, file = 'binding_analysis/KEGG/Dox5_RUNX1_Lost_DownRegulated_KEGG.tsv', sep = '\t', quote = FALSE, row.names = FALSE)
write.table(reto_gained.upReg.KEGG, file = 'binding_analysis/KEGG/Dox5_RUNX1ETO_Gained_UpRegulated_KEGG.tsv', sep = '\t', quote = FALSE, row.names = FALSE)
...
ggsave(g, file = 'binding_analysis/KEGG/Dox5_RUNX1_Lost_DownRegulated_KEGG.png', height = 4, width = 8, dpi = 800, unit = 'in')
ggsave(g, file = 'binding_analysis/KEGG/Dox5_RUNX1_Lost_DownRegulated_KEGG.pdf', height = 4, width = 8, dpi = 800, unit = 'in')
...
ggsave(g, file = 'binding_analysis/KEGG/Dox5_RUNX1ETO_Gained_UpRegulated_KEGG.png', height = 4, width = 8, dpi = 800, unit = 'in')
ggsave(g, file = 'binding_analysis/KEGG/Dox5_RUNX1ETO_Gained_UpRegulated_KEGG.pdf', height = 4, width = 8, dpi = 800, unit = 'in')
