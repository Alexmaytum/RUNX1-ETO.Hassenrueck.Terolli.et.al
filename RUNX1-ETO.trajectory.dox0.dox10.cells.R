...
# Pseudotime
cds<- order_cells(cds = cds, root_pr_nodes = 'Y_27')
...
ggsave(g, file = 'pseudotime_results/Dox0_and_Dox10_Pseudotime.png', dpi = 800, height = 8, width = 9.5)

#############################################################################################################################

# Save Monocle3 object for later
saveRDS(cds, file = 'saved_R_objects/Dox0_and_Dox10_Monocle3.rds')
